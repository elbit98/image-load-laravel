    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <form method="post" action="{{ route('image.load') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="p-6">
                        <div class="flex items-center">
                            <input type="file" accept="image/x-png,image/gif,image/jpeg" onchange="encodeImage(this)">
                            <input type="hidden" name="image" id="image">
                        </div>
                        <p><b>Output:</b></p>
                        <label for="output">
                            <select id="output" class="p-6" name="output">
                    ...
                    <button class="p-6 text-gray-700">Save</button>
                </form>
            </div>
        </div>
    </div>
